...
const Color Color::blue = Color::SetRGB(0, 0, 255);
const Color Color::yellow = Color::SetRGB(255, 255, 0);
const Color Color::white = Color::SetRGB(255, 255, 255);
const Color Color::black = Color::SetRGB(255, 0, 0);
